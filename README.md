...
**Description**: This app allows the user to view the menu of a certain restaurant. When the user clicks on menu items,  
more information is available in a seperate activity (also placed below). 
